...
public class DateUtils {
    ...
    public static String getSexyTime(long millis) {
        ...
        if (years != 0) {
            time.append(years).append("y").append(day == 0 ? "" : ",");
        }

        if (day != 0) {
            time.append(day).append("d").append(hours == 0 ? "" : ",");
        }

        if (hours != 0) {
            time.append(hours).append("h").append(minutes == 0 ? "" : ",");
        }

        if (minutes != 0) {
            time.append(minutes).append("m").append(seconds == 0 ? "" : ",");
        }
